...
I build practical projects that connect hardware, firmware, desktop tools, applied AI, Android device work, and network automation.
...
- HDL/FPGA: Verilog, FPGA/SoC coursework, Platform Designer, HPS/Linux
- Systems: Android device tree basics, Cloudflare Gateway filtering, Git, Linux, Win32 API, Lua scripting
...
- [cloudflare-gateway-pihole-scripts](https://github.com/lhlizdabezt/cloudflare-gateway-pihole-scripts) - JavaScript automation scripts for Cloudflare Gateway filtering, including domain list creation, gateway rule setup, allowlist/blocklist handling, and scheduled updates through GitHub Actions.
...
- Turning coursework, internship experience, and system-level experiments into polished engineering projects.
...
- LinkedIn: [lhlizdabezt](https://www.linkedin.com/in/lhlizdabezt)
