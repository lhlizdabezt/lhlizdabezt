<p align="left">
  <img src="https://komarev.com/ghpvc/?username=lhlizdabezt&label=Profile%20views&color=0e75b6&style=flat" alt="Profile views" />
</p>
...
<p align="center">
  <a href="https://github.com/lhlizdabezt?tab=followers">
    <img src="https://img.shields.io/github/followers/lhlizdabezt?style=for-the-badge&logo=github&label=Follow" alt="GitHub followers" />
  </a>
...
- Python automation, Jupyter/IPYNB notebooks, Kaggle-style experimentation, data workflows, and desktop tooling.
- YOLO/OCR pipelines, computer vision applications, and AI-assisted workflow automation.
- Git/GitHub, Linux, Windows tooling, scripting, documentation, and technical report preparation.
...
![FPGA](https://img.shields.io/badge/FPGA%2FSoC-6D28D9?style=flat)
...
| IoT Coursework | [ThucHanhGTMT](https://github.com/lhlizdabezt/ThucHanhGTMT) | AHT20 temperature-humidity system with Silicon Labs BLE, LCD display, UART logging, and SQLite PC-side data storage. |
| AI / OCR | [NhapMonAI](https://github.com/lhlizdabezt/NhapMonAI) | Vietnamese license plate recognition using YOLO, OCR, Python desktop tools, Android APK, and academic reports. |
| Automation | [messenger-edge-tool](https://github.com/lhlizdabezt/messenger-edge-tool) | Python desktop tool using Microsoft Edge and Playwright for AI-assisted Messenger workflows. |
| Campus Automation | [hcmus-auto-dkhp](https://github.com/lhlizdabezt/hcmus-auto-dkhp) | HCMUS course registration helper userscript with auto tick, optional auto submit, reload loop, and manual CAPTCHA flow. |
