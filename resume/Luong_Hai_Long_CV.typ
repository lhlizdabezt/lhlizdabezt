...
Computer Vision / Machine Learning / Network Communications Intern | Python | PyTorch | OpenCV | TCP/IP \
...
B.Eng. candidate in Electronics and Telecommunications Engineering, completing the program in September 2026. Built course projects in YOLO/OCR inference, DSP-based signal classification, Cisco network configuration, and TCP/IP-connected embedded systems; seeking an internship in computer vision, machine learning, or network and telecommunications engineering.

== Technical Skills
#chiline()

*Languages and tools:* Python, C/C++, MATLAB, Git/GitHub, Jupyter, Kaggle, Linux. \
*Computer vision and ML:* PyTorch, YOLO/Ultralytics, OpenCV, FastALPR, OCR, object detection, scikit-learn. \
...
- Developed a C/Win32 serial diagnostic tool for board bring-up; assisted USB-C PD behavior testing and IGBT/power-board schematic reviews for firmware-hardware alignment.

*Robotics & IoT Club, VNUHCM - University of Science* #h(1fr) Nov 2023 -- Jul 2024 \
Technical Team Member #h(1fr) Ho Chi Minh City \
- Assembled and tested robotics and IoT prototypes; isolated sensor wiring, power, and firmware issues during bring-up using C/Lua test routines.

*Anh Trung Smartphone Store / Xuan Anh Computer* #h(1fr) 2023 -- 2025 \
Repair Technician (Part-time) #h(1fr) Ho Chi Minh City \
- Diagnosed phone, laptop, and PC faults across power, display, storage, thermal, connectors, software, and peripherals; completed functional tests before handover.
...
- Co-developed image/video desktop inference and a bounded PlateGate LAN whitelist demo; maintained Kaggle/IPYNB training evidence, Git LFS assets, and release packaging.
- The YOLO detector reached 99.45% mAP at 0.5 IoU, 99.45% precision, and 99.37% recall on the project validation set.
...
- Developed a six-class I/Q signal-classification workflow with 18 DSP features, a 400-tree Random Forest, and an 81,030-parameter 1D CNN.
...
- Configured and verified six laboratory networks using routing tables, VLAN/trunk state, OSPF adjacencies, DHCP addressing, NAT translation, wireless access, and end-to-end reachability.
...
- Built a LAN prototype in which PC/Android clients send short TCP commands to an HPS Linux daemon, which writes through the lightweight HPS-to-FPGA bridge to drive HEX0-HEX5 displays.
